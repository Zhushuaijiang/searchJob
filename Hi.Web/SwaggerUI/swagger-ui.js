...
function model_SignShowHide(obj) {
    var $obj = $(obj);
    $obj.parent().siblings().find(".model-signature").toggleClass("hide");
    $obj.text($obj.text() == "Hide" ? "Show" : "Hide")
    return false;
}

function showhide_datatype(obj) {
    var $obj = $(obj);
    var $table = $(obj).closest('table');
    $table.find('.model-signature').each(function (i, e) {
        if ($(e).text().length > 20) {
            $(e).toggleClass("hide");
        }
    });
...
(function () {
    ...
    templates['operation'] = template(function (Handlebars, depth0, helpers, partials, data) {
        ...
        function program3(depth0, data) {
            ...
            return "\n                    <h4>Response Class(<a style='font-size:0.9em' href='#' onclick='return model_SignShowHide(this);'>Show</a>)</h4>\n                    <p><span class=\"model-signature hide\" /></p>\n                    <br/>\n                    <div class=\"content-type\" />\n                ";
        }

        function program5(depth0, data) {


            return "\n                    <h4>Parameters</h4>\n                    <table class='fullwidth'>\n                        <thead>\n                        <tr>\n                            <th style=\"width: 100px; max-width: 100px\">Parameter</th>\n                            <th style=\"width: 310px; max-width: 310px\">Value</th>\n                            <th style=\"width: 200px; max-width: 200px\">Description</th>\n                            <th style=\"width: 100px; max-width: 100px\">Parameter Type</th>\n                            <th style=\"width: 220px; max-width: 230px\">Data Type(<a href='#' onclick='return showhide_datatype(this);'>Show</a> complex object)</th>\n                        </tr>\n                        </thead>\n                        <tbody class=\"operation-params\">\n\n                        </tbody>\n                    </table>\n                    ";
        }
        ...
        function program11(depth0, data) {
            ...
            return "\n                    <div class='sandbox_header'>\n                        <input class='submit' name='commit' type='button' value='点击测试' />\n                        <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n                        <img alt='Throbber' class='response_throbber' src='images/throbber.gif' style='display:none' />\n                    </div>\n                    ";
        }
...
(function () {
    ...
    templates['param'] = template(function (Handlebars, depth0, helpers, partials, data) {
        ...
        if (stack1 || stack1 === 0) { buffer += stack1; }
        buffer += "</td>\n<td>\n<span class=\"model-signature hide\" />\n</td>\n\n";
        return buffer;
    });
})();
...
(function () {
    ...
    templates['param_list'] = template(function (Handlebars, depth0, helpers, partials, data) {
        ...
        if (stack1 || stack1 === 0) { buffer += stack1; }
        buffer += "</td>\n<td><span class=\"model-signature hide\" /></td>\n";
        return buffer;
    });
})();
    ...
    ContentTypeView = (function (_super) {
        ...
        ContentTypeView.prototype.render = function () {
            ...
            if (this.isParam) {
                ...
                $('label[for=contentType]', $(this.el)).text('响应的内容类型');
            }
            return this;
        };
