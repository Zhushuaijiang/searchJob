...
function MsgBox(s) {
    ...
    function readyMsgBox() {
        if (s != null){
            if (s.imghref != null) paras.imghref = s.imghref; else paras.imghref = "../../JobResources/Script/common/Msg/images/";
        ...
        else paras = { imghref: "../../JobResources/Script/common/Msg/images/", waitImg: "loader.gif", bgImg: "qzonebg.gif" };
